...
class Hd3Test extends PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		if($this->cloud_HD3->siteDetect()) {
			$this->cloud_reply = $this->cloud_HD3->getReply()["hd_specs"];
		}
		if($this->ultimate_HD3->siteDetect()) {
			$this->ultimate_reply = $this->ultimate_HD3->getReply()["hd_specs"];	
		}
	}	
